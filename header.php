                ...
                <div class="container">
                    ...
                    <nav>
                        ...
                        <ul class="site-nav">
                            ...
                            <!-- END Menu Toggle -->
                            <li>
                                <a href="index.php" class="site-nav-sub">Home</a>

                            </li>
                            <li>
                                <a href="user.php" class="site-nav-sub">User Account</a>
                            ...
                            <li>
                                <a href="includes/logout.inc.php" class="btn btn-success">Log Out</a>
                            </li>
                         </ul>
                        <!-- END Main Menu -->
                    </nav>
